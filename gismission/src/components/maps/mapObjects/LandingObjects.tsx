...
interface LayerResult {
  ...
  createPointFeature: (point: PointData) => Feature;
  loadLandingData: () => Promise<Feature[]>;
}

// 포인트 특성 생성 함수
export const createPointFeature = (point: PointData): Feature => {
...
export const createLandingPointsLayer = (): LayerResult => {
  ...
  return {
    ...
    vectorSource,
    createPointFeature,
    loadLandingData: async (): Promise<Feature[]> => {
      try {
